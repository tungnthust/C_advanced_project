...
void TabuSearch(int TABU_Horizon) {
    ...
    while (Termination != 1) {
        ...
        for (VehIndexFrom = 0; VehIndexFrom < FLEET; VehIndexFrom++) {
            ...
            // printf("Do ");
            // for(int k = 1; k < RouteFromLength - 1; k++) {
            //     printf("%-3d", RouteFrom.array[k]);
            // }
            // printf("*****\n");
        ...
        // Vehicles[SwapRouteFrom].NumNode = 0;
        // Vehicles[SwapRouteFrom].CurLoc = 0;
        // printf("Before:\n");
        // for(int k = 0; k < Vehicles[SwapRouteTo].NumNode; k++) {
        //     printf("%-3d", Vehicles[SwapRouteTo].Route[k]);
        // }
        // printf("\n");
        RouteTo.array = Vehicles[SwapRouteTo].Route;
        RouteTo.size = Vehicles[SwapRouteTo].NumNode;
        // printf("After:\n");
        // for(int k = 0; k < RouteTo.size; k++) {
        //     printf("%-3d", RouteTo.array[k]);
        // }
        // printf("\n");
        // Vehicles[SwapRouteTo].NumNode = 0;
        // Vehicles[SwapRouteTo].CurLoc = 0;
        ...
        // printf("\nBefore:\n");
        // for(int k = 0; k < RouteFrom.size; k++) {
        //     printf("%-3d", RouteFrom.array[k]);
        // }
        // printf("\n");
        //  printf("\nBefore1:\n");
        ...
        // printf("\nAfter:\n");
        // for(int k = 0; k < Vehicles[SwapRouteFrom].NumNode; k++) {
        //     printf("%-3d", Vehicles[SwapRouteFrom].Route[k]);
        // }
    ...
    for (int j = 0 ; j < FLEET ; j++)
    {   
        // for(int k = 0; k < VehiclesForBestSolution[j].NumNode; k++) {
        //     printf("%-3d", VehiclesForBestSolution[j].Route[k]);
        // }
        // printf("\n");
        ...
        //     printf("After %d:\n", j);
        // for(int k = 0; k < Vehicles[j].NumNode; k++) {
        //     printf("%-3d", Vehicles[j].Route[k]);
        // }
        // printf("\n");
    }
